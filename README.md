...
1. Setup a git bare directory in the home folder by usng following guide: [The best way to store your dotfiles: A bare Git repository](https://www.atlassian.com/git/tutorials/dotfiles) tutorial.
